PROGRAM SVALSERR
  ...
  WRITE (OUTPUT_UNIT,'(A)') '"Lx","MINLN","MAXLN","MINLP","MAXLP","MINAE","MAXAE","AVGAE","MINRE","MAXRE","AVGRE"'
  FLUSH(OUTPUT_UNIT)
  ...
  WRITE (OUTPUT_UNIT,'(A)',ADVANCE='NO') '"LY"'
  FLUSH(OUTPUT_UNIT)
