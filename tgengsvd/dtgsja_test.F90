...
CONTAINS
  ...
  SUBROUTINE READCL(M, N, FN, INFO)
    ...
    INFO = 0
    IF (COMMAND_ARGUMENT_COUNT() .NE. 3) STOP 'dtgsja_test.exe M N FN'
    ARG = '                        '
    TMP = 0
