PROGRAM ZORTHO
  ...
  IF (INFO .NE. 0) STOP 'BIO_OPEN'
  CALL BIO_READ_Z2(I, M, N, U, INFO)
  IF (INFO .NE. 0) STOP 'BIO_READ_D2'
  CALL BIO_CLOSE(I, INFO)
  IF (INFO .NE. 0) STOP 'BIO_CLOSE'
...
CONTAINS
  ...
  SUBROUTINE READCL(FN, M, N, INFO)
    ...
    INFO = 0
    IF (COMMAND_ARGUMENT_COUNT() .NE. 3) STOP 'zortho.exe FN M N'
